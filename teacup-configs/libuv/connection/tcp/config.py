...
TPCONF_test_id = 'noprefix' + '_libuvconnectiontcp'
...
traffic_custom = [
    ('0.0', '1', " start_custom_traffic,"
     ...
     " duration=V_duration,"
     " add_prefix='1',"
     " parameters='-R %s -A -s -C %s -a %s -b %s -I %s -M %s -p %s -u %s' % ('fredhau/testhost2-freebsd/libuv/connection/tcp', str(int(V_connections) * int(V_flows)), V_flows, '0', '172.16.10.2', V_transports, 12327, 2)"),
    ('2.0', '2', " start_custom_traffic,"
     ...
     " duration=V_duration,"
     " add_prefix='1',"
     " parameters='-R %s -A -s -C %s -a %s -b %s -i %s -l %s -M %s -n %s -u %s %s %s' % ('fredhau/testhost5-freebsd/libuv/connection/tcp', V_flows, V_flows, '0', '172.16.11.4', 10240, V_transports, V_flows, 2, '172.16.10.2', 12327)"),
]
